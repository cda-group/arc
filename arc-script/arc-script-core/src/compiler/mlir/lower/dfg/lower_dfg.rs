use crate::compiler::dfg::lower::hir::eval::value::ValueKind;
...
impl Lower<ConstKind, Context<'_>> for ValueKind {
    ...
    fn lower(&self, _ctx: &mut Context<'_>) -> ConstKind {
        match self {
            ...
            Self::Str(_)        => crate::todo!(),
            Self::Bool(_v)      => crate::todo!(),
            Self::Item(_)       => crate::todo!(),
            Self::Task(_, _)    => crate::todo!(),
            Self::Stream(_, _)  => crate::todo!(),
            Self::Vector(_)     => crate::todo!(),
            Self::Tuple(_)      => crate::todo!(),
            Self::Array(_)      => crate::todo!(),
            Self::Variant(_, _) => crate::todo!(),
            Self::Struct(_)     => crate::todo!(),
        }
    }
}
