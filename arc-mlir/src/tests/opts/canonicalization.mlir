...
// CHECK-DAG: [[V1XF32:%[^ ]+]] = constant dense<-3.40282347E+38> : tensor<1xf32>
...
// CHECK-DAG: [[V3XF32:%[^ ]+]] = constant dense<[-3.40282347E+38, 3.140000e+00, 6.930000e-01]> : tensor<3xf32>
...
// CHECK-DAG: [[V3XI64:%[^ ]+]] = constant dense<[3, 4, 5]> : tensor<3xi64>
