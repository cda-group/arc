...
module @toplevel {
  // expected-error@+1 {{appender merge type must be a value type, got: '!arc.appender<i32>'}}
...
module @toplevel {
  // expected-error@+1 {{appender merge type must be a value type, got: 'tuple<i32, !arc.appender<i32>>'}}
