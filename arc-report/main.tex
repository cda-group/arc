...
% References
% \usepackage{cite} % Improved handling of numerical citations
\usepackage{natbib} % Flexible bibliography support

% Spacing
\usepackage{mparhack} % Allow multiple paragraphs in text
\usepackage{marginfix} % Allow multiple paragraphs in text
